...
const framer     = require("./http2_mod/lib/protocol/framer");
const compressor = require("./http2_mod/lib/protocol/compressor");
...
const protocol = {
  ...
  Connection:   require("./http2_mod/lib/protocol/connection").Connection,
};
