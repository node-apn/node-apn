...
Connection.prototype.validNotification = function (notification, recipient) {
	...
	if (messageLength > 256) {
		process.nextTick(function () {
			this.raiseError(Errors['invalidPayloadSize'], {"notification": notification, "recipient": recipient});
			this.emit('transmissionError', Errors['invalidPayloadSize'], {"notification": notification, "recipient": recipient});
		}.bind(this));
		return false;
	}
	return true;
