...
Connection.prototype.maintainMinConnection = function() {
    if (typeof (this.options.minConnections - this.sockets.length) === 'number') {
        if (this.sockets.length >= this.options.minConnections) {
                return;
            }
            if (this.deferredConnection === null && this.sockets.length < this.options.minConnections) {
...
Connection.prototype.createNewConnection = function() {
    if (this.deferredConnection === null && this.sockets.length < this.options.maxConnections) {
        this.createConnection();
    }
};
/**
