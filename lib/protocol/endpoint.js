...
module.exports = function(dependencies) {
  ...
  Endpoint.prototype._setupHTTP2Pipeline = function _setupHTTP2Pipeline() {
    ...
    const serializer = new protocol.Serializer(this.options.http2Logger || noopLogger.child("serializer"));
    const compressor = new protocol.Compressor(this.options.http2Logger || noopLogger.child("compressor"), "REQUEST");
    const deserializer = new protocol.Deserializer(this.options.http2Logger || noopLogger.child("deserializer"));
    const decompressor = new protocol.Decompressor(this.options.http2Logger || noopLogger.child("decompressor"), "RESPONSE");
