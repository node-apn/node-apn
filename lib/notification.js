...
/**
 * Get a compiled notification.
 * If you notify same content to dozen of devices, follow the method below for more memory efficient delivery:
 * 1. compile the notification before start sending.
 * 2. use it for sending relative methods, Connection#addNotification or Connection#broadcast.
 */
Notification.prototype.getCompiledNotification = function () {
    return {
        isCompiled: true,
        payload: new Buffer(JSON.stringify(this), this.encoding || 'utf8'),
        expiry: this.expiry
    };
};
